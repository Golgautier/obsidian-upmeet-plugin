...
async function getMeetingSummary(meetingId, upmeetToken) {
  ...
  try {
    const response = await (0, import_obsidian.requestUrl)(urlRequest).json;
...
async function getMeetings(plugin) {
  ...
  while (currentPage <= totalPages) {
    try {
      response = await (0, import_obsidian.requestUrl)(urlRequest).json;
    } catch (error) {
...
var GolUpmeetSettingTab = class extends import_obsidian5.PluginSettingTab {
